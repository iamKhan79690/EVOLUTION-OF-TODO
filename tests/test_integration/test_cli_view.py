...
def test_view_tasks_via_cli():
    ...
    assert "[1]" in output  # Task ID
    assert "[2]" in output  # Task ID
    assert "○ [1] Task 1" in output  # Pending task with ID and description
    assert "✓ [2] Task 2" in output  # Completed task with ID and description
